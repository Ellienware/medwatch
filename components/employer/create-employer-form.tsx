...
import { createEmployer } from "@/lib/actions/employer-actions"
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (result.success) {
        ...
        router.push("/clinic/employers")
        router.refresh()
      } else {
        toast({
          title: "Error",
          description: result.error || "Failed to create employer.",
          variant: "destructive",
        })
      }
    } catch (error) {
      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Enter the company's official details</CardDescription>
          </CardHeader>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch id="portal_enabled" name="portal_enabled" value="true" defaultChecked={false} />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch id="auto_receive_certificates" name="auto_receive_certificates" value="true" defaultChecked />
            </div>

            <div className="rounded-lg border p-4">
              <h4 className="mb-2 text-sm font-medium">Portal Access Information</h4>
              <p className="text-sm text-muted-foreground">
                Once created, the employer will receive login credentials via email to access their portal.
                They can view employee certificates and medical status reports.
              </p>
            </div>
          </CardContent>
        </Card>
